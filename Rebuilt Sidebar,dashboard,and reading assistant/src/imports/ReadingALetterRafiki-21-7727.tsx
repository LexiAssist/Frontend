import svgPaths from "./svg-j23xcfznyw";

function BackgroundComplete() {
  return (
    <div className="absolute inset-[0_0_7.01%_0]" data-name="background-complete">
...
function BackgroundSimple() {
  return (
    <div className="absolute inset-[1.08%_12.76%_13.53%_19.34%]" data-name="background-simple">
...
function Shadow() {
  return (
    <div className="absolute inset-[93.92%_11.22%_0_11.22%]" data-name="Shadow">
...
function Letter() {
  return (
    <div className="absolute inset-[26.87%_19.4%_2.46%_43.69%]" data-name="Letter">
...
function MailBox() {
  return (
    <div className="absolute inset-[45.79%_71.99%_2.47%_17.31%]" data-name="mail-box">
...
function Character() {
  return (
    <div className="absolute inset-[28.88%_52.37%_2.47%_31.53%]" data-name="Character">
