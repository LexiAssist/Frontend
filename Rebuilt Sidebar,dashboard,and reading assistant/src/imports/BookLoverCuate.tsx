import svgPaths from "./svg-orfo16v6sb";

function BackgroundComplete() {
  return (
    <div className="absolute inset-[0_2.67%_30.61%_3.08%]" data-name="background-complete">
...
function BackgroundSimple() {
  return (
    <div className="absolute inset-[4.34%_8.32%_39.66%_15.81%]" data-name="background-simple">
...
function Floor() {
  return (
    <div className="absolute inset-[72.46%_0_27.3%_0]" data-name="Floor">
...
function Shadows() {
  return (
    <div className="absolute inset-[81.57%_3.17%_0_6.25%]" data-name="Shadows">
...
function Books() {
  return (
    <div className="absolute inset-[41.04%_1.67%_1.75%_28.92%]" data-name="Books">
...
function Character() {
  return (
    <div className="absolute inset-[43.03%_13.67%_2.81%_0.36%]" data-name="Character">
...
function Hearts() {
  return (
    <div className="absolute inset-[36.63%_70.54%_39%_17.8%]" data-name="Hearts">
...
export default function BookLoverCuate() {
  return (
    <div className="relative size-full" data-name="book-lover/cuate">
      <BackgroundComplete />
      <BackgroundSimple />
      <Floor />
      <Shadows />
