import svgPaths from "./svg-ipuzmyymat";
...
import { imgGroup, imgGroup1, imgGroup2, imgGroup3 } from "./svg-3tt75";
...
function UilSetting({ className }: { className?: string }) {
  return (
    <div className={className || "relative shrink-0 size-[32px]"} data-name="uil:setting">
...
function MaterialSymbolsLightClearNight({ className }: { className?: string }) {
  return (
    <div className={className || "relative shrink-0 size-[32px]"} data-name="material-symbols-light:clear-night">
...
function Frame7() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
      <UilSetting />
      <MaterialSymbolsLightClearNight />
    </div>
  );
}
...
function BackgroundComplete() {
  return (
    <div className="col-1 h-[133.757px] ml-0 mt-0 relative row-1 w-[192.888px]" data-name="background-complete">
...
function BackgroundSimple() {
  return (
    <div className="col-1 h-[122.813px] ml-[37.3px] mt-[1.55px] relative row-1 w-[130.97px]" data-name="background-simple">
...
function Shadow() {
  return (
    <div className="col-1 h-[8.741px] ml-[21.65px] mt-[135.09px] relative row-1 w-[149.596px]" data-name="Shadow">
...
function Letter() {
  return (
    <div className="col-1 h-[101.64px] ml-[84.27px] mt-[38.65px] relative row-1 w-[71.2px]" data-name="Letter">
...
function MailBox() {
  return (
    <div className="col-1 h-[74.411px] ml-[33.39px] mt-[65.87px] relative row-1 w-[20.643px]" data-name="mail-box">
...
function Character() {
  return (
    <div className="col-1 h-[98.74px] ml-[60.82px] mt-[41.54px] relative row-1 w-[31.065px]" data-name="Character">
...
function BackgroundComplete1() {
  return (
    <div className="col-1 h-[117.949px] ml-[5.95px] mt-0 relative row-1 w-[181.795px]" data-name="background-complete">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="background-complete" opacity="0">
...
function BackgroundSimple1() {
  return (
    <div className="col-1 h-[95.18px] ml-[30.5px] mt-[7.38px] relative row-1 w-[146.333px]" data-name="background-simple">
...
function Floor() {
  return (
    <div className="col-1 h-[0.404px] ml-0 mt-[123.17px] relative row-1 w-[192.89px]" data-name="Floor">
...
function Shadows() {
  return (
    <div className="col-1 h-[31.33px] ml-[12.06px] mt-[138.64px] relative row-1 w-[174.71px]" data-name="Shadows">
...
function Books() {
  return (
    <div className="col-1 h-[97.254px] ml-[55.79px] mt-[69.75px] relative row-1 w-[133.871px]" data-name="Books">
...
function Character1() {
  return (
    <div className="col-1 h-[92.07px] ml-[0.69px] mt-[73.13px] relative row-1 w-[165.819px]" data-name="Character">
...
function Hearts() {
  return (
    <div className="col-1 h-[41.427px] ml-[34.32px] mt-[62.25px] relative row-1 w-[22.497px]" data-name="Hearts">
...
function Frame14() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-full items-start relative shrink-0 w-[188px]">
      ...
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.45] relative shrink-0 text-[#555c56] text-[14px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Study with confidence as words are simplified into bits
      </p>
    </div>
  );
}
...
function BackgroundComplete2() {
  return (
    <div className="col-1 h-[133.206px] ml-0 mt-0 relative row-1 w-[192.89px]" data-name="background-complete">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="background-complete" opacity="0">
...
function BackgroundSimple2() {
  return (
    <div className="col-1 h-[89.758px] ml-[32.18px] mt-[5.36px] relative row-1 w-[128.506px]" data-name="background-simple">
...
function Shadow1() {
  return (
    <div className="col-1 h-[8.705px] ml-[21.65px] mt-[134.32px] relative row-1 w-[149.598px]" data-name="Shadow">
...
function Plant() {
  return (
    <div className="col-1 h-[30.919px] ml-[85.34px] mt-[104.83px] relative row-1 w-[22.338px]" data-name="Plant">
...
function Lines() {
  return (
    <div className="col-1 h-[6.455px] ml-[88.28px] mt-[35.3px] relative row-1 w-[12.505px]" data-name="Lines">
...
function Character2() {
  return (
    <div className="col-1 h-[120.166px] ml-[91.41px] mt-[20.16px] relative row-1 w-[54.43px]" data-name="character-2">
...
function Character3() {
  return (
    <div className="col-1 h-[121.854px] ml-[54.62px] mt-[18.3px] relative row-1 w-[41.901px]" data-name="character-1">
...
function FriendlyHandshakeRafiki() {
  return (
...
function Frame16() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] h-full items-start relative shrink-0 w-[176px]">
      <p className="font-['Roboto:SemiBold',sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[#272a28] text-[24px] tracking-[-0.48px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        StudyBuddy
      </p>
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[1.45] relative shrink-0 text-[#555c56] text-[14px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
...
function BackgroundComplete3() {
  return (
    <div className="col-1 h-[135.985px] ml-[0.84px] mt-[6.04px] relative row-1 w-[142.529px]" data-name="background-complete">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
        <g id="background-complete" opacity="0">
...
function BackgroundSimple3() {
  return (
    <div className="col-1 h-[117.326px] ml-[3.7px] mt-0 relative row-1 w-[136.403px]" data-name="background-simple">
...
function Device() {
  return (
    <div className="col-1 h-[136.906px] ml-[42.77px] mt-[5.12px] relative row-1 w-[67.419px]" data-name="Device">
...
function Character4() {
  return (
    <div className="col-1 h-[120.675px] ml-[12.29px] mt-[21.38px] relative row-1 w-[39.577px]" data-name="Character">
...
function SpeechBubble() {
  return (
    <div className="col-1 h-[21.09px] ml-[2.45px] mt-[14.61px] relative row-1 w-[21.776px]" data-name="speech-bubble">
...
function Plant1() {
  return (
    <div className="col-1 h-[77.371px] ml-[114.49px] mt-[64.71px] relative row-1 w-[26.697px]" data-name="Plant">
...
function Floor1() {
  return (
    <div className="col-1 h-[0.171px] ml-0 mt-[141.95px] relative row-1 w-[143.811px]" data-name="Floor">
...
function MynauiFileSolid() {
  return (
    <div className="relative shrink-0 size-[24px]" data-name="mynaui:file-solid">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="mynaui:file-solid">
          <path d={svgPaths.p20ebc00} fill="url(#paint0_linear_13_6820)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_13_6820" x1="12" x2="12" y1="2.25" y2="21.75">
...
function MaskGroup() {
  return (
    <div className="absolute inset-[16.67%_12.5%]" data-name="Mask group">
      <div className="absolute inset-[-5.62%_-5%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16.5 14.8333">
          <g id="Mask group">
            <mask height="15" id="mask0_13_7435" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} width="17" x="0" y="0">
              <g id="Group">
                <g id="Group_2">
                  <path d={svgPaths.p19ec8600} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                  <path d={svgPaths.p2d186600} fill="var(--fill-0, #555555)" id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
                </g>
              </g>
            </mask>
            <g mask="url(#mask0_13_7435)">
              <path d={svgPaths.p1208280} fill="var(--fill-0, black)" id="Vector_3" />
            </g>
          </g>
        </svg>
      </div>
...
function IconParkTwotoneMemoryCard({ className }: { className?: string }) {
  return (
    <div className={className || "relative shrink-0 size-[20px]"} data-name="icon-park-twotone:memory-card">
      <MaskGroup />
    </div>
  );
}
